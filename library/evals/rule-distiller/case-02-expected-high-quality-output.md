...
The requester provides all mandatory intake fields, including a traceable source and explicit CONFIRM gate. The agent must produce a structured instruction file with separated BC and NBP sections, operational checklist, and full source traceability.
...
May I create/modify files after preview: yes
...
1. A complete instruction file at `library/instructions/laravel-11.md` containing:
...
2. Preview shown before file creation (since CONFIRM was given).
3. Decision log with actor, decision, and ISO-8601 timestamp.

## PASS Criteria (all required)

1. File is created at the exact path `library/instructions/laravel-11.md`.
...
9. Preview is shown before file write is executed.
...
- No decision log.
- File created without showing a preview first.
